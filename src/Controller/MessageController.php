...
final class MessageController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_front_forum_show', [], Response::HTTP_SEE_OTHER);
        }
    ...
    public function edit(Request $request, Message $message, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_front_forum_show', [
   ...
   #[Route('/{id}/delete', name: 'app_message_delete', methods: ['POST'])]
    public function delete(Request $request, Message $message, EntityManagerInterface $entityManager): Response
    {
        ...
        // Si tu veux revenir à la liste des messages
        //return $this->redirectToRoute('app_message_index');

        // Si tu veux revenir au forum où le message était posté
        return $this->redirectToRoute('app_front_forum_show', [
            'id' => $message->getForum()->getId()
        ]);
    }
