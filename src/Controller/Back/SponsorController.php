...
class SponsorController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('back_sponsor_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'back_sponsor_delete', methods: ['POST'])]
    ...
    #[Route('/{id}/export/pdf', name: 'back_sponsor_export_pdf', methods: ['GET'])]
    public function exportPdf(Sponsor $sponsor): Response
    {
        $html = $this->renderView('back/sponsor/report_pdf.html.twig', [
            'sponsor' => $sponsor,
            'date' => new \DateTime(),
        ]);
    ...
    #[Route('/{id}/export/excel', name: 'back_sponsor_export_excel', methods: ['GET'])]
