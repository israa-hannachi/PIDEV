...
class ModuleController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(ModuleType::class, $module, [
            'lock_categorie' => ($module->getCategorie() !== null),
        ]);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($module->getCategorie()) {
                return $this->redirectToRoute('admin_categorie_show', ['id' => $module->getCategorie()->getId()], Response::HTTP_SEE_OTHER);
            }
    ...
    public function edit(Request $request, Module $module, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_module_show', ['id' => $module->getId()], Response::HTTP_SEE_OTHER);
        }
    ...
    public function delete(Request $request, Module $module, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($categorieId) {
            return $this->redirectToRoute('admin_categorie_show', ['id' => $categorieId], Response::HTTP_SEE_OTHER);
        }
