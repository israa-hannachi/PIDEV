...
import 'schema/meet_record.dart';
...
export 'schema/meet_record.dart';
export 'schema/participant_record.dart';

/// Functions to query MeetRecords (as a Stream and as a Future).
Future<int> queryMeetRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MeetRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MeetRecord>> queryMeetRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      MeetRecord.collection,
      MeetRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MeetRecord>> queryMeetRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
